        ...
        while($row = mysqli_fetch_array($result))
        {
         ...
         <tr>
          ...
          <td style="font-size: 10px">
            ...
            <span class="btn btn-primary btn-md" data-toggle="modal" data-target="#edit'.$row["id"].'">EDIT</span>&nbsp &nbsp &nbsp &nbsp &nbsp
            <span class="btn btn-danger btn-md delete" name="'.$row["id"].'">DELETE</span>
